...
class YellowBulb : ApotheoticItem
{
    ...
    public override ScreenText Dialogue(bool forServer)
    {
        ...
        return ApotheosisDialogueCache.StartLine("$Mods.Verdant.ScreenText.Apotheosis.ItemInteractions.YellowBulb.0").
            With(new ScreenText("$Mods.Verdant.ScreenText.Apotheosis.ItemInteractions.YellowBulb.1")).
            FinishWith(new ScreenText("$Mods.Verdant.ScreenText.Apotheosis.ItemInteractions.YellowBulb.2"));
    }
}