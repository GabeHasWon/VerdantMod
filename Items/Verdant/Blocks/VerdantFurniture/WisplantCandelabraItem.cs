...
namespace Verdant.Items.Verdant.Blocks.VerdantFurniture
{
    ...
    public class WisplantCandelabraItem : ModItem
    {
        ...
        public override void AddRecipes() => QuickItem.AddRecipe(this, TileID.LivingLoom, 1, (ModContent.ItemType<LushLeaf>(), 6), (ModContent.ItemType<Lightbulb>(), 1), (ModContent.ItemType<WisplantItem>(), 2));
    }
}