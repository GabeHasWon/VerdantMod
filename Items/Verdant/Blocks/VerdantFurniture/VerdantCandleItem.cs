...
namespace Verdant.Items.Verdant.Blocks.VerdantFurniture
{
    public class VerdantCandleItem : ModItem
    {
        ...
        public override void AddRecipes() => QuickItem.AddRecipe(this, mod, Terraria.ID.TileID.LivingLoom, 1, (ItemType<VerdantStrongVineMaterial>(), 1), (ItemType<Lightbulb>(), 1));
    }
}