...
namespace Verdant.Items.Verdant.Blocks.VerdantFurniture
{
    public class VerdantChandelierBlock : ModItem
    {
        ...
        public override void AddRecipes() => QuickItem.AddRecipe(this, mod, TileID.WorkBenches, 1, (ItemType<LushLeaf>(), 6), (ItemType<RedPetal>(), 6), (ItemType<VerdantStrongVineMaterial>(), 4), (ItemType<Lightbulb>(), 3));
    }
}