...
namespace Verdant.Items.Verdant.Blocks.VerdantFurniture
{
    ...
    public class VerdantCandelabraItem : ModItem
    {
        ...
        public override void AddRecipes() => QuickItem.AddRecipe(this, TileID.LivingLoom, 1, (ModContent.ItemType<LushLeaf>(), 3), (ModContent.ItemType<PinkPetal>(), 2), (ModContent.ItemType<Lightbulb>(), 1));
    }
}