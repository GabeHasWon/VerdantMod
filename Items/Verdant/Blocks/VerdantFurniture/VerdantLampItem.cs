...
namespace Verdant.Items.Verdant.Blocks.VerdantFurniture
{
    public class VerdantLampItem : ModItem
    {
        ...
        public override void AddRecipes() => QuickItem.AddRecipe(this, mod, TileID.WorkBenches, 1, (ItemType<LushLeaf>(), 4), (ItemType<VerdantStrongVineMaterial>(), 3), (ItemID.Torch, 1));
    }
}