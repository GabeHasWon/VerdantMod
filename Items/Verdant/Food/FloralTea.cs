...
public class FloralTea : FoodItem
{
    ...
    public override void AddRecipes() => QuickItem.AddRecipe(this, Mod, TileID.CookingPots, 1, (ItemID.BottledWater, 1), (ModContent.ItemType<RedPetal>(), 2), (ModContent.ItemType<LushLeaf>(), 1));
}
