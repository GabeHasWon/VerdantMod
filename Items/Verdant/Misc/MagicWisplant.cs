...
internal class MagicWisplant : ModItem
{
    ...
    public override void AddRecipes() => QuickItem.AddRecipe(this, Mod, TileID.Bottles, 1, (ModContent.ItemType<LushLeaf>(), 4), (ModContent.ItemType<WisplantItem>(), 1), (ItemID.Star, 1));
}
