...
namespace Verdant.NPCs
{
	...
	public static class NPCLootHelper
	{
		...
		public static void AddMasterModeDropOnAllPlayers<T>(this ILoot loot) where T : ModItem => loot.Add(ItemDropRule.MasterModeDropOnAllPlayers(ModContent.ItemType<T>()));
