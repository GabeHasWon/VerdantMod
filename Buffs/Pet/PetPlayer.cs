...
namespace Verdant.Buffs.Pet
{
	...
	/// Simply put this line in the pet's AI: <code>Owner.GetModPlayer&lt;GlobalClasses.Players.PetPlayer>().PetFlag(Projectile);</code><br/>
	/// Copied from my own implementation in SpiritMod.
	/// </summary>
