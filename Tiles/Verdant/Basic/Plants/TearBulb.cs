...
public class TearBulb : ModTile
{
    ...
    {
        internal static bool NearTearBulb = false;

        public override void ResetNearbyTileEffects() => NearTearBulb = false;
    }
    ...
    public override void SetStaticDefaults()
    {
        ...
        QuickTile.SetMulti(this, 2, 2, ModContent.DustType<VerdantWaterSplash>(), SoundID.Grass, false, new Color(105, 135, 168));
    }

    public override void NearbyEffects(int i, int j, bool closer)
    {
        if (Main.tile[i, j].TileFrameY == 36)
            TearBulbFlag.NearTearBulb = true;
    }

    //public override void EmitParticles(int i, int j, Tile tile, short tileFrameX, short tileFrameY, Color tileLight, bool visible)
    //{
    //    if (Main.tile[i, j].TileFrameY == 38)
