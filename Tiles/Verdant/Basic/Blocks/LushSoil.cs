...
namespace Verdant.Tiles.Verdant.Basic.Blocks
{
    internal class LushSoil : ModTile
    {
        public override void SetStaticDefaults()
        {
            ...
            QuickTile.MergeWith(Type, TileID.Dirt, TileID.Mud, ModContent.TileType<VerdantGrassLeaves>(), ModContent.TileType<VerdantPinkPetal>(), ModContent.TileType<VerdantRedPetal>(), TileID.Glass);
        }
    }
}