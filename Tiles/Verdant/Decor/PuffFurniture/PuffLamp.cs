...
public class PuffLamp : ModTile
{
    ...
    {
        public override void SetDefaults() => QuickItem.SetBlock(this, 16, 32, ModContent.TileType<PuffLamp>());
    ...
    public override void SetStaticDefaults()
    {
        ...
        RegisterItemDrop(ModContent.ItemType<VerdantLampItem>());
        AddMapEntry(new Color(255, 112, 202), Language.GetText("MapObject.FloorLamp"));
    }
