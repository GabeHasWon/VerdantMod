...
public class WisplantCandelabra : ModTile
{
    public override void SetStaticDefaults() => CandelabraHelper.Defaults<WisplantCandelabraItem>(this, new Color(253, 221, 3), false);
