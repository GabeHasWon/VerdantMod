...
namespace Verdant.Tiles.Verdant.Decor.VerdantFurniture
{
    internal class VerdantSofa : ModTile
    {
        ...
        public override void KillMultiTile(int i, int j, int frameX, int frameY) => Item.NewItem(i * 16, j * 16, 32, 16, ItemType<Items.Verdant.Blocks.LushWood.LushTableItem>());
    }
}