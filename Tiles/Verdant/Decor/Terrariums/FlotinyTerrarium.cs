...
public class FlotinyTerrarium : ModTile
{
    ...
    public override bool PreDraw(int i, int j, SpriteBatch spriteBatch)
    {
        ...
        {
            Main.instance.LoadNPC(ModContent.NPCType<Flotiny>());
            Texture2D tex = TextureAssets.Npc[ModContent.NPCType<Flotiny>()].Value;
            ...
            Texture2D glowTex = Flotiny.glowTexture.Value;
