...
{
    public class VerdantWoodChest : ModTile
    {
        ...
        public override void MouseOver(int i, int j)
        {
            ...
            {
                player.cursorItemIconText = Main.chest[chest].name.Length > 0 ? Main.chest[chest].name : "Lush Wood Chest";
                if (player.cursorItemIconText == "Lush Wood Chest")
                {
                    player.cursorItemIconID = ModContent.ItemType<VerdantWoodChestBlock>();
