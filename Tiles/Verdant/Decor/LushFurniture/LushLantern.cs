...
{
    internal class LushLantern : ModTile
    {
        public override void SetStaticDefaults()
        {
            ...
            AddMapEntry(new Color(114, 69, 39), Language.GetText("MapObject.Lantern"));
        }

        public override void KillMultiTile(int i, int j, int frameX, int frameY)
        {
            Item.NewItem(new EntitySource_TileBreak(i, j), i * 16, j * 16, 16, 48, ModContent.ItemType<Items.Verdant.Blocks.LushWood.LushLanternItem>());
        }
