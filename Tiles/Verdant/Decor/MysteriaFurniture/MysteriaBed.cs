...
public class MysteriaBed : ModTile
{
	public override void SetStaticDefaults()
	{
        ...
        AddMapEntry(new Color(124, 93, 68), Language.GetText("ItemName.Bed"));
    }

	public override bool HasSmartInteract(int i, int j, SmartInteractScanSettings settings) => true;
	public override void NumDust(int i, int j, bool fail, ref int num) => num = 1;
	public override void KillMultiTile(int i, int j, int frameX, int frameY) => Item.NewItem(new EntitySource_TileBreak(i, j), i * 16, j * 16, 64, 32, ModContent.ItemType<MysteriaBedItem>());
    ...
    public override void MouseOver(int i, int j)
    {
        ...
        else
        {
            player.noThrow = 2;
            player.cursorItemIconEnabled = true;
            player.cursorItemIconID = ModContent.ItemType<MysteriaBedItem>();
        }
    }
}